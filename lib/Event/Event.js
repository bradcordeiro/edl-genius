  ...
  constructor(input, sourceFrameRate, recordFrameRate) {
    if (input) {
      ...
      if (typeof input === 'string' && RegexPatterns.CMX_EVENT_REGEX.test(input)) {
        ...
        if (input.sourceFrameRate) this.sourceFrameRate = input.sourceFrameRate;
        if (input.recordFrameRate) this.recordFrameRate = input.recordFrameRate;
        if (input.number) this.number = input.number;
        if (input.reel) this.reel = input.reel;
        if (input.trackType) this.trackType = input.trackType;
        if (input.transition) this.transition = input.transition;
        ...
        if (input.sourceClip) this.sourceClip = input.sourceClip;
        if (input.sourceFile) this.sourceFile = input.sourceFile;
        if (input.motionEffect) this.motionEffect = new MotionEffect(input.motionEffect);
        if (input.comment) this.comment = input.comment;
      } else {
