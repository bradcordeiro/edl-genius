...
var Event_js_1 = __importDefault(require("../lib/Event.js"));
describe('Event Class', function () {
    it('new Event() should create an empty event', function () {
        var event = new Event_js_1.default();
        assert_1.default.strictEqual(event.number, undefined);
    });
    it('new Event({Object}) should copy argument\'s properties to Event', function () {
        var obj = {
            number: 3,
            reel: 'BOONE_SM',
            trackType: 'V',
        ...
        var event = new Event_js_1.default(obj);
    ...
    it('new Event({Object}) with Timecode string properties should convert Timecode strings to Timecode class) ', function () {
        var event = new Event_js_1.default({
    ...
    it('setMotionEffect() should add a motionEffect property', function () {
        var event = new Event_js_1.default();
    ...
    it('toObject() should return an object with the correct properties', function () {
        var event = new Event_js_1.default({
            number: 3,
            reel: 'BOONE_SM',
            trackType: 'V',
        ...
        assert_1.default.deepStrictEqual(json.sourceStart, { hours: 1, minutes: 1, seconds: 43, frames: 5, frameRate: 29.97 });
        assert_1.default.deepStrictEqual(json.sourceEnd, { hours: 1, minutes: 1, seconds: 57, frames: 0, frameRate: 29.97 });
        assert_1.default.deepStrictEqual(json.recordStart, { hours: 1, minutes: 0, seconds: 7, frames: 26, frameRate: 29.97 });
        assert_1.default.deepStrictEqual(json.recordEnd, { hours: 1, minutes: 0, seconds: 21, frames: 21, frameRate: 29.97 });
    });
});
