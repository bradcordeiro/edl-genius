...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "stream", "../lib/CMX3600Parser.js"], factory);
    }
    ...
    const CMX3600Parser_js_1 = __importDefault(require("../lib/CMX3600Parser.js"));
    ...
    describe('CMX3600Parser', () => {
        describe('Events', () => {
            it('piping CMX 3600 string should parse to Event properties', function (done) {
                ...
                const output = new CMX3600Parser_js_1.default();
                const results = [];
                ...
                output.on('end', () => {
                    ...
                    if (results[0].sourceStart) {
                        assert_1.default.deepStrictEqual(results[0].sourceStart, { hours: 1, minutes: 1, seconds: 43, frames: 5, frameRate: 29.97 }); /* eslint-disable-line object-curly-newline */
                    }
                    else {
                        assert_1.default.strictEqual(true, false, 'Source Start was not set.');
                    }
                    if (results[0].sourceEnd) {
                        assert_1.default.deepStrictEqual(results[0].sourceEnd, { hours: 1, minutes: 1, seconds: 57, frames: 0, frameRate: 29.97 }); /* eslint-disable-line object-curly-newline */
                    }
                    else {
                        assert_1.default.strictEqual(true, false, 'Source End was not set.');
                    }
                    if (results[0].recordStart) {
                        assert_1.default.deepStrictEqual(results[0].recordStart, { hours: 1, minutes: 0, seconds: 7, frames: 26, frameRate: 29.97 }); /* eslint-disable-line object-curly-newline */
                    }
                    else {
                        assert_1.default.strictEqual(true, false, 'Record Start was not set.');
                    }
                    if (results[0].recordEnd) {
                        assert_1.default.deepStrictEqual(results[0].recordEnd, { hours: 1, minutes: 0, seconds: 21, frames: 21, frameRate: 29.97 }); /* eslint-disable-line object-curly-newline */
                    }
                    else {
